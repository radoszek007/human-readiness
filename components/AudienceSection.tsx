    ...
    <section id="audience" className="bg-bg-secondary py-20 text-white sm:py-24">
      <div className="section-shell">
        <div className="max-w-4xl">
          ...
          <h2 className="font-heading text-3xl font-bold leading-tight sm:text-5xl">Kde má Resilium největší smysl</h2>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {audiences.map((audience) => (
            <article key={audience.title} className="dark-card min-h-56 p-6">
              <h3 className="font-heading text-xl font-bold">{audience.title}</h3>
