...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6">
      ...
      >
        <a href="#" className="flex items-center gap-3" aria-label="Resilium domů">
          <Image
            src="/logo-cele.png"
            alt="Resilium"
            width={174}
        ...
        <a href={consultationMailto} className="hidden rounded-full bg-accent px-4 py-2.5 text-sm font-extrabold text-white transition hover:bg-accent-warm lg:inline-flex">
          Ověřit připravenost
        </a>
