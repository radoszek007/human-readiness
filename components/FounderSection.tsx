      ...
      <div className="section-shell">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-3xl font-bold leading-snug text-dark sm:text-4xl">
              Odborné vedení opřené o praxi v osobní bezpečnosti, komunikaci a výcviku pod tlakem
            </h2>
