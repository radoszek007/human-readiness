      ...
      <div className="section-shell">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="font-heading text-3xl font-black leading-tight sm:text-5xl">Resilium trénuje funkční reakci</h2>
          </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {pillars.map((pillar, index) => (
            <article key={pillar.title} className="dark-card p-6">
              <span className="text-sm font-black text-accent-soft">{String(index + 1).padStart(2, "0")}</span>
              <h3 className="mt-5 font-heading text-xl font-extrabold">{pillar.title}</h3>
